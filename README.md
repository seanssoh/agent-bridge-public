...
**Current stable**: v0.13.10 (2026-05-15).
- v0.7.x → v0.13.x leap path: **upgrade to v0.13.10 or later**. The v0.13.7-v0.13.10 cycle resolved a four-stage `agent-bridge upgrade --apply` blocker (Bash 5.3.9 heredoc-stdin deadlock chain + markerless layout reject). See [OPERATIONS.md §"v0.13.x hotfix wave"](./OPERATIONS.md) for the upgrade recipe.
- macOS: works in shared-mode (default). Linux-user isolation is Linux-only.
- Stabilization roadmap (post-v0.13.10): [`docs/stabilization-plan-2026-05-15.md`](./docs/stabilization-plan-2026-05-15.md).
