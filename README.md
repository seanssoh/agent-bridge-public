...
- v0.7.x → v0.14.x leap path: **first upgrade to v0.13.10 (heredoc deadlock chain fixed)**, then upgrade to v0.14.0. The two steps are both `agent-bridge upgrade --apply`; see [OPERATIONS.md §"Upgrade"](./OPERATIONS.md#upgrade) for the recipe and the v0.13.x / v0.14.0 follow-up notes.
