...
DOCTOR_KNOWN_DENIAL_PATTERNS=(
  ...
  "--launch-cmd-add-dev-channel token invalid (need plugin:NAME@SPEC or server:NAME): *"
  "--launch-cmd-remove-dev-channel token invalid (need plugin:NAME@SPEC or server:NAME): *"
  "--channels-set token invalid (need plugin:NAME@SPEC or server:NAME): *"
  "--channels-add token invalid (need plugin:NAME@SPEC or server:NAME): *"
  "--channels-remove token invalid (need plugin:NAME@SPEC or server:NAME): *"
