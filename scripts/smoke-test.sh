...
[[ -L "$CLAUDE_STATIC_WORKDIR/.claude/skills/agent-bridge-operating-manual" ]] || die "expected shared agent-bridge operating manual skill symlink"
...
assert_contains "$(readlink "$CLAUDE_STATIC_WORKDIR/.claude/skills/agent-bridge-operating-manual")" "agent-bridge-operating-manual"
...
assert_contains "$(cat "$REPO_ROOT/.claude/skills/agent-bridge-operating-manual/SKILL.md")" "Agent Bridge 운영 매뉴얼"
assert_contains "$(cat "$REPO_ROOT/.claude/skills/agent-bridge-operating-manual/SKILL.md")" "목차 + 강제 체크리스트"
