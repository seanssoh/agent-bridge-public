...
select_for_path() {
  ...
  case "$path" in
    ...
    lib/bridge-skills.sh|.claude/skills/*)
      ...
      add_required isolated-skills-sync isolation launch 1151-step-a-helper
      add_integration integration-minimal
      ;;
