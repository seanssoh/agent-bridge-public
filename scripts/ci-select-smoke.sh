...
select_for_path() {
  ...
  case "$path" in
    ...
    bridge-doctor.py)
      ...
      add_required 1455-settings-two-tree-doctor orphan-agent-dir agent-doctor 1786-tasksdb-doctor-verb 1803-orphan-dir-gc
      ;;
