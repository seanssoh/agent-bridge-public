...
select_for_path() {
  ...
  case "$path" in
    ...
    plugins/ms365/server.ts|plugins/teams/server.ts)
      ...
      # messaging endpoint.
      add_required 1209-ms365-redirect-resolver 1215-ms365-dir-mode
      add_integration integration-minimal
      ;;
