...
select_for_path() {
  ...
  case "$path" in
    ...
    hooks/tool-policy.py|bridge-config.py|lib/system_config_paths.py)
      ...
      add_required hooks agent-update v2-cross-class-read admin-hook-exemption tool-policy-roster-read-classify 1205-hook-iso-fail-open
      add_integration integration-minimal
      ;;
