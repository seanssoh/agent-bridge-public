...
select_for_path() {
  ...
  case "$path" in
    ...
    bridge-setup.py|bridge-setup.sh|bridge-status.py|bridge-status.sh)
      ...
      add_required queue upgrade-conflicts-lifecycle status-engine-detect 835-static-admin-launch 1155-bootstrap-skill-guard 1165-track-a-scaffold-modes 1170-safe-path-check-sudo-escalate
      add_integration integration-minimal
      ;;
