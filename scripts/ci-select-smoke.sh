...
select_for_path() {
  ...
  case "$path" in
    ...
    bridge-daemon.sh|bridge-sync.sh|bridge-watchdog.sh|bridge-cron.sh|lib/bridge-cron.sh|lib/bridge-state.sh|lib/bridge-notify.sh)
      ...
      add_required 1379-iso-cron-staging-group
    ...
    lib/cron-helpers/*.py)
      ...
      add_required cron-run-artifacts-retention cron-shell-runner beta5-2-eta-cron-iso-uid-preflight 1359-cron-create-iso-staging 1379-iso-cron-staging-group queue
      add_integration integration-minimal
      ;;
    ...
    bridge-cron.py|bridge-cron-runner.py|bridge-cron-scheduler.py)
      ...
      add_required cron-run-artifacts-retention cron-migrate-payloads cron-mutation-audit cron-shell-runner cron-runner-schema-openai-strict cron-path-augmentation-874 queue beta5-2-eta-cron-iso-uid-preflight 1359-cron-create-iso-staging 1379-iso-cron-staging-group
      add_integration integration-minimal
      ;;
