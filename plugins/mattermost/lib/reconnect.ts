 ...
 * the backoff resets. On thrown error (connection failed), the current delay
 * is used, then doubled for the next retry. The loop exits when `abortSignal`
 * fires.
 *
 * No external dependencies — vendored verbatim.
 */
