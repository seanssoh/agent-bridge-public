...
try:
    ...
    # which copies only the script without the adjacent lib/) must still import
    ...
    # that never spawn import fine; any path that actually reaches the spawn
    # raises loudly instead of launching the child unsuppressed.
